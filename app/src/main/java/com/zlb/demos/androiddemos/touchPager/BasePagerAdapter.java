...
public abstract class BasePagerAdapter<T> extends PagerAdapter {
	...
	BasePagerAdapter(Context context, RecycleBin recycleBin) {
		mContext = context;
	 ...
	 * {@link LayoutInflater#inflate(int, ViewGroup, boolean)} to specify a root view and to
	...
	public static class RecycleBin {
		 ...
		 * end of layout all view in activeViews are moved to scrapViews. Views in activeViews represent a contiguous
		...
		/**
		 * Makes sure that the size of scrapViews does not exceed the size of activeViews. (This can happen if an
